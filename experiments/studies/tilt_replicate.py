"""Independent replication of the one positive result.
...
FIRST_RUN = {  # variance win rates from tilt_confirm.py, for the comparison
    (0.3, 0.5): 0.67, (0.3, 1.0): 0.63,
    (1.0, 0.5): 0.73, (1.0, 1.0): 0.67,
}
