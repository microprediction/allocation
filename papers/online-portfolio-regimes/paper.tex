...
\texttt{partial\_fit} each period over an exponentially-weighted covariance. This
is the setting of online learning---one decision per period against a changing
world, judged by regret \parencite{cover1991, hazan2016}---and the Thurstone tilt
in particular is a follow-the-perturbed-leader rule, which perturbs abilities and
takes the winner \parencite{hannan1957, kalaivempala2005}. They
