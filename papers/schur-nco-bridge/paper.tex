...
approximate joint law \parencite{vecchia1988,katzfuss2021}. The conditionals
...
\textcite{katzfuss2021}. The covariance results in this note do not need
Gaussianity.
...
\cref{prop:sufficient,prop:bridge,prop:outer}, the precision sparsity
implied by \cref{cor:gaussian}, the remarks on diagnostics, on the loss, on
covariance-only rules and on the tree, and the symmetric-factor formula,
