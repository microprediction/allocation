...
\Cref{sec:apps}. Open questions: whether its choice-sensitivity Jacobian
$\nabla_\theta w$---a correlation-aware metric on the simplex---is a useful
preconditioner; and how to control the redistribution of de-duplicated credit to
weak contributors, the one cost that recurs across the attribution and selection
experiments. The construction and its calibration inverse are implemented in the
