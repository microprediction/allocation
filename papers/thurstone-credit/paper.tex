...
the membership-game Shapley value itself.
...
contributors. The construction and its calibration inverse are implemented in the
open-source \texttt{allocation} package, built on \texttt{thurstone}.
% TODO: axiom audit; variable-selection experiment vs stability selection.
