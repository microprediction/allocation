...
the membership-game Shapley value itself. A numerical confirmation, and a
measurement of the divergence on a worked five-contributor example, are in
\texttt{experiments/shapley\_bridge.py}.
