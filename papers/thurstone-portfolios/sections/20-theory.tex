...
cluster that limit is $\tfrac12$ regardless of $|G|$. Whether a given parametric
family (Clayton, say, at fixed margins) deepens $M_G$ monotonically is a
family-specific question; \Cref{fig:tail} shows that it does for the family used
there.
